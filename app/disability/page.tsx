      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-300">
            Protect your income with comprehensive disability coverage
          </p>
        </div>
        ...
        <div className="mt-8 space-y-8 backdrop-blur-sm bg-white/5 p-8 rounded-xl border border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-white">Why Choose Our Disability Insurance?</h3>
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() => router.push('/quote/disability')}
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-4 text-gray-300">
            ...
            <p>Trusted by thousands of professionals nationwide</p>
          </div>
        </div>
      </div>
    </div>
